...
@section('title', 'تقرير مبيعات التحويلات المالية')

@section('content')
<div class="container-fluid py-4">
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-money-check-alt me-2"></i>تقرير مبيعات التحويلات المالية</h5>
        </div>
        <div class="card-body">
            <!-- Summary boxes -->
            <div class="row mb-4">
                <div class="col-lg-6 col-md-6">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <h5 class="card-title">إجمالي فواتير التحويلات</h5>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <h5 class="card-title">إجمالي مبيعات التحويلات</h5>
                            <h2 class="mb-0">{{ number_format($totalTransferSales, 2) }}</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        @php
                            $displayTotal = $invoice->type === 'mixed' ? $invoice->payments->where('method', 'transfer')->sum('amount') : $invoice->total;
                        @endphp
                        <tr>
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-4 text-muted">
                                ...
                                <p>لا توجد فواتير تحويلات مالية</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
