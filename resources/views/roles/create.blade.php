...
<div class="container">
    <div class="row mb-3">
        <div class="col-md-8">
            ...
            <p class="text-muted">قم بإنشاء دور جديد وتحديد الصلاحيات المناسبة له</p>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <h5 class="mb-0 py-1">
                <i class="fas fa-user-tag me-1 text-primary"></i> معلومات الدور الجديد
            </h5>
        </div>
        <div class="card-body">
            <form action="{{ route('roles.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        @enderror
                        <div class="form-text">أدخل اسماً مميزاً للدور مثل "مدير مخزن" أو "محاسب"</div>
                    </div>
                </div>
