        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0">إضافة مجموعة جديدة</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" 
                                       id="color" name="color" value="{{ old('color', '#2563eb') }}" title="اختر لوناً">
                                <input type="text" class="form-control" id="colorHex" value="#2563eb" readonly>
                            </div>
                            @error('color')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">يمكنك اختيار صورة للمجموعة (اختياري)</div>
                            @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
